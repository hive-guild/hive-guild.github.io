...
import {
  ...
  serverModeLabel, modePreferenceStats,
} from "./raid-roles.js";
...
// Play-mode artwork. PVE shows a peace sign, "Mir egal" a shrug; PVP keeps its crossed swords.
// Same table for the registration form, the public overview and the admin panel.
const serverModeIcons = { PVE: "mode-peace.svg", PVP: "server-pvp-art.png", ANY: "mode-shrug.svg" };
...
function updateDerivedRole() {
  // Hidden until a class is picked; once it is, the shown role is the one that would be saved.
  const role = choice("class") ? derivedRole() : "–";
