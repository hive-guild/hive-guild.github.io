...
function renderAvailabilityInsights(entries, prefix = "") {
  ...
  if (shared.status === "available") {
    ...
    const messages = { empty: "Noch keine Rückmeldungen vorhanden.", incomplete: "Die Verfügbarkeit ist noch nicht für alle vollständig angegeben.", none: "Es gibt keinen gemeinsamen Tag mit einem Zeitfenster der bei allen passt." };
