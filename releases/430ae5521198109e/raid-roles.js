...
// Display label per role. The stored value stays "Flexible" - the database mirrors it in a check
// constraint (db/supabase.sql) - so only the wording shown to visitors changes here.
export const raidRoleLabels = { Tank: "Tank", Healer: "Healer", "Melee DPS": "Melee DPS", "Ranged DPS": "Ranged DPS", Flexible: "tbd" };
export const raidRoleLabel = (role) => raidRoleLabels[role] ?? role;
