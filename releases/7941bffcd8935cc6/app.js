...
function updateDerivedRole() {
  // The whole field stays hidden until a spec is picked, so no role is announced before the
  // player has confirmed a class and a spec. The value shown afterwards is the one that would be
  // saved, so preview and roster can never disagree.
