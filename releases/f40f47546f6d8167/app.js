...
function paintSignupAside(mode = state.mode) {
  const copy = mode === "loading" ? {
    ...
    heading: "Zeit für ein Update?",
    body: "Schon wieder rerollt oder haben sich deine Raidzeiten geändert? Deine Anmeldung ist bereits geladen. Passe einfach deine Angaben an und speichere die Änderungen. So planen wir mit deinem aktuellen Stand.",
  } : {
    label: "NICE TO KNOW",
